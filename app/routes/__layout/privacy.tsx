...
export default function PrivacyPage() {
  return (
    <main>
      ...
      <p>
        Fredagslunchen.club takes your privacy seriously. To better protect your
      ...
      <p>
        ...
        use our website. We use Fathom Analytics for our website analytics,
        which doesn't use cookies and complies with the GDPR, ePrivacy
        (including PECR), COPPA and CCPA. Your IP address is only briefly
        processed, and we have no way of identifying you. As per the CCPA, your
      ...
      <p>
        This Privacy Policy is effective as of 2022-08-01 and will remain in
